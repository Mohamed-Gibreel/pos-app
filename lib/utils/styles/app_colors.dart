...
class AppColors {
  ...
  static final lightAppColors = AppColorsExtension(
    ...
    primaryGradientTo: convertHexToColorObject('2E9055'),
    neutralGradientFrom: convertHexToColorObject('89898B'),
    neutralGradientTo: convertHexToColorObject('202020'),
    infoGradientFrom: convertHexToColorObject('1D90FB'),
    infoGradientTo: convertHexToColorObject('0E5EA9'),
    warningGradientFrom: convertHexToColorObject('FFAB00'),
    warningGradientTo: convertHexToColorObject('C6880C'),
    errorGradientFrom: convertHexToColorObject('F04D28'),
    errorGradientTo: convertHexToColorObject('AA371C'),
    outlineGradientFrom: convertHexToColorObject('E5E5E5'),
    outlineGradientTo: convertHexToColorObject('A3A3A3'),
    // Error
